                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit.subcategory',$sub->id) }}"
                                           class="btn btn-sm btn-info bol"><i class="fa fa-edit"> Edit</i></a>
                                        <a href="{{ route('delete.subcategory',$sub->id) }}"
                                           class="btn btn-sm btn-danger" id="delete"><i class="fa fa-trash"> Delete</i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
