...
@section('content')
    ...
    @php
        ...
        $hot      = DB::table('products')
                        ...
                        ->where('hot_deal',1)->where('products.status',1)->orderBy('id','DESC')->limit(3)
                        ->get();
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{asset($row->image_one)}}" alt=""
                                                         style="width: 100px;height: 120px;"></div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img
                                                    ...
                                                    style="width: 330px;height: 300px;border-radius: 20px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @php
        ...
        $cat_id = $cats->id;
        $product = DB::table('products')->where('category_id',$cat_id)->where('status',1)->limit(10)
                        ->orderBy('id','DESC')->get();
                    ...
                    <div
                        ...
                        <div class="newsletter_content clearfix">
                            <form action="{{ route('store.newslater') }}" method="POST" class="newsletter_form">
                                @csrf
                                <input type="email" class="newsletter_input @error('email') is-invalid @enderror"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <img src="" id="pimage">
                                <div class="card-body"><h5 class="card-title text-center" id="pname"></h5></div>
                            </div>
                        </div><!-- col-md-4 -->
                            ...
                            <div class="card">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">Stock : <span class="badge"
                                                                              style="background-color: green;color: white;">Available</span>
                                    </li>
                                </ul>
                            </div>
                        </div><!-- col-md-4 -->
                        ...
                        <div class="col-md-4">
                            <form method="POST" action="{{ route('insert.into.cart') }}">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputquanity">Quantity</label>
