            ...
            <div class="row">
                        ...
                        <div class="sidebar_section">
                            ...
                            <ul class="sidebar_categories">
                                ...
                                @foreach($category as $cat)
                                    <li><a href="{{ url('all/category/'.$cat->id) }}">{{ $cat->category_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="shop_content">
                        ...
                        @if($cat_all->count())
                            @foreach($cat_all as $row)
                                <!-- Product Item -->
                                    <div class="product_item is_new">
                                        <div class="product_border"></div>
                                        <div
                                            class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset($row->image_one) }}" style="width: 100px;height: 120px;"
                                                 alt=""></div>
                                            ...
                                            <div class="product_name">
                                                <div>
                                                    <a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}"
                                                       tabindex="0">{{ $row->product_name }}</a></div>
                                            </div>
                                        </div>
                                ...
                                @endforeach
                            @else
                                <strong class="text-center text-danger"> No Categories Available
                                    Yet!</strong>
                            @endif
